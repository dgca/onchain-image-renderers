...
import "./ISVGPixelArtRendererV1.sol";

/// @title SVG Pixel Art Renderer V1
/// @author typeof.eth
contract SVGPixelArtRendererV1 is ISVGPixelArtRendererV1 {
  ...
  function createSVGString(
    ...
    return
      string(_createSVGData(_design, _palette, _width, _height, _pixelSize));
  }
